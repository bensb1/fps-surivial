...
public class EnemyController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //memorize the chase distance
        // so it we can put it back
    ...
    void Chase()
    {
        ...
        //set the player's positon as the destination
        ...
        // if the distance betwwen enemy and player is less than the attack distance
        if (Vector3.Distance(transform.position, target.position) <= attack_Distance)
        {
            ...
            else if (Vector3.Distance(transform.position, target.position) > chase_Distance)
            {
                ...
                //can calculate the new patrol desitination right away
                patrol_Timer = patrol_For_This_Time;
                //reset the chase distance to previous
                if (chase_Distance != current_Chase_Distance)
                {
